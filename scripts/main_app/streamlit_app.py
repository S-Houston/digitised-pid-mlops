...
# Ensure Scripts/Pipeline is in the Python path
sys.path.append(os.path.join(os.path.dirname(__file__), '..', 'Pipeline'))

# Import custom scripts
from yolo_object_detection import detect_objects_and_draw_boxes, detect_objects, load_model
from east_text_detector import detect_text
from text_extraction import process_text_files
from image_deconstruction import slice_images
from image_reconstruction import reconstruct_images

# Define directories
source_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..', 'Dataset', 'Demo'))
...
text_model_path = 'C:/Users/Stuart/Documents/Honours_Project/East/frozen_east_text_detection.pb'
